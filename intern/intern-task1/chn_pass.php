...
if ($result ->password==$_POST['oldpass']) {
	if ($result) {
		if ($_POST['cpass'] == $_POST['newpass']) {
            ...
            window.location.href = 'pass_chn.php';
            </script>
        ";
	...
	<div class="container">
		...
		<form action="" method="post" enctype="multipart/form-data">
			...
			<div class="fdl">
				...
				<input id="oldpass" name="oldpass" type="text" placeholder="*****" required>
			...
			<div class="fdl">
				...
				<input id="newpass" name="newpass" type="text" placeholder="*****" required>

			</div>
			<div class="fdr">

				<label for="cpass">Confirm Password</label>
				<input id="cpass" name="cpass" type="cpass" placeholder="alex.hunter@email.com" required>
